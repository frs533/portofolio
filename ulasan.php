...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['delete'])) {
        ...
        $delete_query = "DELETE FROM tbl_ulasan WHERE id_ulasan = $id_to_delete";
        ...
        header("Location: updateUlasan.php?id=$id_to_update"); 
    }
}
...
if (isset($_GET['search'])) {
    ...
    $query = "SELECT u.*, a.*
              ...
              WHERE a.id_ulasan LIKE '%$search%' OR a.isi_ulasan LIKE '%$search%'
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">
                            Ulasan
                            <a href="tambahUlasan.php" class="btn btn-success ms-3"> Tambah Ulasan</a>   
                        </h1>
                        <div class="row mt-3">
                            <div class="col">
                                <div class="card mb-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="display: flex;">
                                                            <form method='post'>
                                                                <input type='hidden' name='update' value='<?= $row["id_ulasan"] ?>'>
                                                                <button type="submit" class="btn btn-outline-secondary me-2">
                                                                    <i class="fa-sharp fa-light fa-pen"></i>
                                                                </button>
                                                            </form>
                                                            <form method='post'>
                                                                <input type='hidden' name='delete' value='<?= $row["id_ulasan"] ?>'>
