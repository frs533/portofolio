...
$totalBarang = "SELECT COUNT(id_barang) AS jumlah_barang FROM tbl_databarang";

$Barang = $conn->query($totalBarang);
$Barang = $Barang->fetch_assoc();

$totalPesanan = "SELECT COUNT(id_pesanan) AS jumlah_pesanan FROM tbl_pesanan";
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link text-white" href="dashboard.php">
                                ...
                                <a class="nav-link text-white fw-bolder" href="dashboard.php">
                                    <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt text-white fw-bolder"></i></div>
                                    Dashboard
                                </a>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row mt-5">
                            <div class="col-xl-4 col-md-6">
                                <div class="card mb-4" style="background-color: #CFC4C4;">
                                    <div class="card-body">
                                        <h2><?=$Barang['jumlah_barang']?></h2>
                                        <h5>Jumlah Produk</h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="card mb-4" style="background-color: #CFC4C4;">
                                    <div class="card-body">
                                        <img src="assets/img/transaksi.png" alt="" width="35" height="46">
                                        <h5>Transaksi</h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="card mb-4" style="background-color: #CFC4C4;">
                                    <div class="card-body">
                                        ...
                                        <table class="table bg-white" style="border-radius: 5px;">
                                            <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>ID Pesanan</th>
