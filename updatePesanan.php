...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['search'])) {
        ...
        $update_query = "UPDATE tbl_pesanan SET id_user='$id_user', total_biaya='$total_biaya', tgl_pesanan='$tgl_pesanan', status_pesanan='$status_pesanan', metode_pembayaran='$metode_pembayaran' WHERE id_pesanan='$id_pesanan'";
...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM tbl_pesanan WHERE id_pesanan='$id_pesanan'";
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <input type="date" name="tgl_pesanan" id="tgl_pesanan" class="form-control" value="<?php echo $tgl_pesanan; ?>" required><br><br>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-1 me-3">
                                            ...
                                            <div class="col-3">
                                                <input type="text" name="status_pesanan" id="status_pesanan" class="form-control" value="<?php echo $status_pesanan; ?>" required><br><br>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-1 me-3">
