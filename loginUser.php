...
<html lang="en">
    ...
    <body class="sb-nav-fixed" style="background-color: #F3E8E8;">
        <nav class="sb-topnav navbar navbar-expand navbar-primary justify-content-between none-mobile" style="background-color: #F3E8E8;">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="text-mobile">
                                    ...
                                    <p><span class="bold-mobile">Sign into your account</span> <br> Or register for exclusive offers</p>
                                </div>
                            ...
                            <div class="col-md-7 none-mobile">
                                <img src="assets/img/loginImage.png" alt="image.png" class="img-fluid px-2 mb-5" style="max-width: 100%;max-height:100%;">
                            </div>
                        </div>
                    </div>
                </main>
