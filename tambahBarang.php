...
if($_POST){
    ...
    if (isset($_POST['search'])) {
        $search = $_POST['search'];
        header("Location: barang.php?search=$search"); 
    } else {
        ...
        if (move_uploaded_file($_FILES["ft_barang"]["tmp_name"], $target_file)) {
            ...
            $query = "INSERT INTO tbl_databarang (nama, harga, deskripsi, ft_barang, material, ukuran, warna, tipe) 
                    VALUES ('$nama', $harga, '$deskripsi', '$target_file', '$material', '$ukuran', '$warna', '$tipe')";
                                ...
                                <div class="card mb-4">
                                    ...
                                    <form action="#" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-3">
                                                <input type="file" name="ft_barang" id="ft_barang" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="offset-1">
