...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['delete'])) {
        ...
        $delete_query = "DELETE FROM tbl_coment WHERE id_coment = $id_to_delete";
        ...
        header("Location: updateComent.php?id=$id_to_update"); 
    }
}
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    $query = "SELECT c.*, u.nama_pelanggan
              FROM tbl_coment c
              JOIN tbl_user u ON c.id_user = u.id_user
              WHERE c.id_coment LIKE '%$search%' OR c.id_user LIKE '%$search%' OR c.isi_coment LIKE '%$search%'
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">
                            Coment
                            <a href="tambahComent.php" class="btn btn-success ms-3"> Tambah Coment</a>   
                        </h1>
                        <div class="row mt-3">
                            <div class="col">
                                <div class="card mb-4">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row["isi_coment"] ?></td>
                                                    <td>
                                                        <div style="display: flex;">
                                                            <form method='post'>
                                                                <input type='hidden' name='update' value='<?= $row["id_coment"] ?>'>
                                                                <button type="submit" class="btn btn-outline-secondary me-2">
                                                                    <i class="fa-sharp fa-light fa-pen"></i>
                                                                </button>
                                                            </form>
                                                            <form method='post'>
                                                                <input type='hidden' name='delete' value='<?= $row["id_coment"] ?>'>
