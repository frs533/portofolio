                                ...
                                <div class="card mb-4">
                                    ...
                                    <form action="#" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <textarea name="isi_coment" id="isi_coment" class="form-control" required></textarea><br><br>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-1">
                                            ...
                                            <div class="col-3">
                                                <input type="date" name="tgl_coment" id="tgl_coment" class="form-control" required><br><br>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <input type="text" name="id_barang" id="id_barang" class="form-control" required><br><br>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="offset-1">
