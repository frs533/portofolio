        ...
        <div id="layoutAuthentication" class="mt-5"> 
            <div id="layoutAuthentication_content">
                <main>
                    ...
                    <div class="container-fluid mt-5" id="main-account">
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="home.php" class="text-decoration-none text-dark">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><a href="account.php" class="text-decoration-none text-dark">Account Dashboard</a></li>
                            </ol>
                        </nav>
                        <h1 class="fs-1 fw-bolder"> WELCOME <?= strtoupper($_SESSION['nama'])?></h1>
                        <h2 class="fs-2 fw-bolder"> This is your Account Dashboard</h2>
                        <h5 class="fs-5 "> Account Information</h5>
                        <h5 class="fs-5 mt-5"> 
                            NAME:
                            <br>
                            <?= ucwords(strtolower($_SESSION['nama']))?>
                            <br>
                            USERNAME:
                            <br>
                            <?= ucwords(strtolower($_SESSION['username']))?>
                        </h5>
                    </div>
                </main>
            </div>
