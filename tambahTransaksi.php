                                ...
                                <div class="card mb-4">
                                    ...
                                    <form action="" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <input type="text" name="no_rek" id="no_rek" class="form-control" required><br><br>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-1 me-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <input type="date" name="tgl_transaksi" id="tgl_transaksi" class="form-control" required><br><br>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-1 me-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <input type="text" name="status_transaksi" id="status_transaksi" class="form-control" required><br><br>
                                            </div>
                                        </div>
